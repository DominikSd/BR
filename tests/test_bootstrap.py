...
def test_required_paths_exist() -> None:
    required_paths = [
        ...
        PROJECT_ROOT / "src" / "botlab" / "domain" / "__init__.py",
        PROJECT_ROOT / "src" / "botlab" / "application" / "__init__.py",
        PROJECT_ROOT / "src" / "botlab" / "adapters" / "__init__.py",
        PROJECT_ROOT / "src" / "botlab" / "adapters" / "telemetry" / "__init__.py",
        PROJECT_ROOT / "src" / "botlab" / "adapters" / "simulation" / "__init__.py",
